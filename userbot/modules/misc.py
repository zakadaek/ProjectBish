...
async def reedme(e):
    await e.edit(
        ...
        "\n[ProjectBishUserBot's README.md file](https://github.com/BianSepang/ProjectBish/blob/master/README.md)"
        ...
        "\n[Generate String Session](https://stringsession.biansepang.repl.run)")
